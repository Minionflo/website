...
(function($) {
    ...
    $("#requestForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            ...
            rformError();
            rsubmitMSG(false, "Bitte fülle alle Felder aus");
        } else {
    ...
    function rformSuccess() {
        $("#requestForm")[0].reset();
        rsubmitMSG(true, "Anfrage gesendet");
    ...
    $("#contactForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            // handle the invalid form...
            cformError();
            csubmitMSG(false, "Bitte fülle alle Felder aus");
        } else {
            // everything looks good!
            event.preventDefault();
            csubmitForm();
    ...
    function cformSuccess() {
        $("#contactForm")[0].reset();
        csubmitMSG(true, "Nachricht gesendet");
        $("input").removeClass('notEmpty'); // resets the field label after submission
    ...
    $("#privacyForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            // handle the invalid form...
            pformError();
            psubmitMSG(false, "Bitte fülle alle Felder aus");
        } else {
            // everything looks good!
            event.preventDefault();
            psubmitForm();
    ...
    function pformSuccess() {
        $("#privacyForm")[0].reset();
        psubmitMSG(true, "Anfrage gesendet");
        $("input").removeClass('notEmpty'); // resets the field label after submission
    }
